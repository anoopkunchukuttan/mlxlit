...
class AttentionModel():
    def __init__(self,mapping,representation,embedding_size,max_sequence_length):
        ...
        #self.input_encoder=BidirectionalRnnEncoder(embedding_size,max_sequence_length,rnn_size)

        ## CNN Encoder
        filter_sizes=[1,2,3,4]
        self.input_encoder=CNNEncoder(embedding_size,max_sequence_length,filter_sizes,rnn_size*2/len(filter_sizes))
